...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, onSectionChange }) => {
  const menuItems = [
    ...
    { id: 'rescued-pets', label: 'Rescued Pets', icon: Heart, },
    { id: 'lost-pets', label: 'Lost Pets', icon: PawPrint, },
    { id: 'profile', label: 'Profile', icon: User, },
  ];

  // ✅ Removed fixed positioning classes. The component now fills its parent wrapper.
  return (
    <aside className="w-64 h-full bg-white/80 backdrop-blur-md shadow-2xl border-r border-white/20 pt-16">
      <div className="p-6">
